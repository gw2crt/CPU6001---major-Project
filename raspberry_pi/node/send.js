...
var characteristicUuids = ['19b10001e8f2537e4f6cd104768a1216','4227f3b1d6a24fb2a9163bee580a9c84','4227f3b1d6a24fb2a9163bee580a9c86'];
      ...
      service.discoverCharacteristics(characteristicUuids, function(error, characteristics) {        
        ...
        console.log('discovered characteristics');
          ...
          ledCharacteristic.on('data', function(data, isNotification) {
              myArray[0] =  data.readFloatLE().toFixed(2);
